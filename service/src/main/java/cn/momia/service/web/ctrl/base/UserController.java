...
public class UserController extends AbstractController {
    ...
    public ResponseMessage updateName(@PathVariable long id, @RequestParam String name) {
        boolean successful = userService.updateName(id, name);
    ...
    public ResponseMessage updateDesc(@PathVariable long id, @RequestParam String desc) {
        boolean successful = userService.updateDesc(id, desc);
    ...
    public ResponseMessage updateSex(@PathVariable long id, @RequestParam int sex) {
        boolean successful = userService.updateSex(id, sex);
    ...
    public ResponseMessage updateAvatar(@PathVariable long id, @RequestParam String avatar) {
        boolean successful = userService.updateAvatar(id, avatar);
    ...
    public ResponseMessage updateAddress(@PathVariable long id, @RequestParam String address) {
        boolean successful = userService.updateAddress(id, address);
    ...
    public ResponseMessage updateIdCardNo(@PathVariable long id, @RequestParam String idCardNo) {
        boolean successful = userService.updateIdCardNo(id, idCardNo);
    ...
    public ResponseMessage updateIdCardPic(@PathVariable long id, @RequestParam String idCardPic) {
        boolean successful = userService.updateIdCardPic(id, idCardPic);
