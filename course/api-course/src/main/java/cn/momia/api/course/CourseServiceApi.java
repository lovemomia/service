...
public class CourseServiceApi extends HttpServiceApi {
    ...
    public PagedList<Course> queryBookable(long packageId, int start, int count) {
        MomiaHttpParamBuilder builder = new MomiaHttpParamBuilder()
                .add("pid", packageId)
                .add("start", start)
                .add("count", count);
        return executeReturnPagedList(MomiaHttpRequestBuilder.GET(url("/course/bookable/query"), builder.build()), Course.class);
    }
    ...
    public boolean registerVipCard(long userId, String name, String mobile, String card, String password) {
        MomiaHttpParamBuilder builder = new MomiaHttpParamBuilder()
                .add("uid", userId)
                .add("name", name)
                .add("mobile", mobile)
