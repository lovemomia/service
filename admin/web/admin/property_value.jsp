            ...
            <div class="box span12">
                <div class="row-fluid sortable">
                    <div class="box-header well" data-original-title>
                        <h2><i class="icon-user"></i> 属性值</h2>
                        <div class="box-icon">
                            <a href="${ctx}/property/info.do?uid=${user.id}" class="btn btn-back btn-round"><i class="icon-remove"></i></a>
                        </div>
                    </div>
                    <div class="box-content">
                        <form class="form-horizontal" id="vform" action="${ctx}/property/addvalue.do?uid=${user.id}&pid=${model.id}" method="post">
                            <fieldset>
                        ...
                        <form >
                            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                                <c:forEach items="${entitys}" var="entity">
                                    <tr>
                                        <td>属性值编号:<c:out value="${entity.id}"></c:out><br>
                                            属性值:<c:out value="${entity.value}"></c:out><br>
                                            <a class="btn btn-danger" href="${ctx}/property/delvalue.do?uid=${user.id}&id=${entity.id}&pid=${model.id}">
