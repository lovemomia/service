            ...
            <div class="box span12">
                <div class="row-fluid sortable">
                    <div class="box-header well" data-original-title>
                        <h2><i class="icon-user"></i> 增加SKU的价格</h2>
                        <div class="box-icon">
                            <a href="${ctx}/sku/info.do?uid=${user.id}&pageNo=${pageNo}" class="btn btn-back btn-round"><i class="icon-remove"></i></a>
                        </div>
                    </div>
                    <div class="box-content">
                        <form class="form-horizontal" id="vform" action="${ctx}/sku/price.do?uid=${user.id}&pageNo=${pageNo}" method="post">
                            <fieldset>
                                <input class="input-xlarge focused" id="id" name="id" type="hidden" value="${model.id}" >
