                        ...
                        <form class="form-horizontal" id="vform" action="${ctx}/product/addcontent.do?uid=${user.id}&pid=${model.id}&pageNo=${pageNo}" method="post">
                            <fieldset>
                                ...
                                <div class="control-group">
                                    <div class="controls">
                                        <textarea id="hdts1" name="hdts1" rows="3" cols="5" ></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
                                        <textarea id="hdts2" name="hdts2" rows="3" cols="5" ></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
                                        <textarea id="hdts3" name="hdts3" rows="3" cols="5" ></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
                                        <textarea id="hdts4" name="hdts4" rows="3" cols="5" ></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
                                        <textarea id="hdts5" name="hdts5" rows="3" cols="5" ></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">图文详情</label>
                                    <div class="controls">
                                        <input id="hdts_lb1" name="hdts_lb1" value=""><br>
                                        <textarea id="hdts_lk" name="hdts_lk" rows="3" cols="5" ></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    <div class="controls">
                                        <input id="hdsm_lb1" name="hdsm_lb1" value=""><br>
                                        <textarea id="hdsm1" name="hdsm1" rows="3" cols="5" ></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
                                        <input id="hdsm_lb2" name="hdsm_lb2" value=""><br>
                                        <textarea id="hdsm2" name="hdsm2" rows="3" cols="5" ></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
                                        <input id="hdsm_lb3" name="hdsm_lb3" value=""><br>
                                        <textarea id="hdsm3" name="hdsm3" rows="3" cols="5" ></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
                                        <input id="hdsm_lb4" name="hdsm_lb4" value=""><br>
                                        <textarea id="hdsm4" name="hdsm4" rows="3" cols="5" ></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
                                        <input id="hdsm_lb5" name="hdsm_lb5" value=""><br>
                                        <textarea id="hdsm5" name="hdsm5" rows="3" cols="5" ></textarea>
                                    </div>
                                </div>
                                <div class="box-header well" data-original-title>
                                ...
                                <div class="control-group">
                                    <div class="controls">
                                        <textarea id="hdlc1" name="hdlc1" rows="3" cols="5" ></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
                                        <textarea id="hdlc2" name="hdlc2" rows="3" cols="5" ></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
                                        <textarea id="hdlc3" name="hdlc3" rows="3" cols="5" ></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
                                        <textarea id="hdlc4" name="hdlc4" rows="3" cols="5" ></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
                                        <textarea id="hdlc5" name="hdlc5" rows="3" cols="5" ></textarea>
                                    </div>
                                </div>
                                <div class="box-header well" data-original-title>
                                ...
                                <div class="control-group">
                                    <div class="controls">
                                        <input id="jhxx_lb1" name="jhxx_lb1" value=""><br>
                                        <textarea id="jhxx1" name="jhxx1" rows="3" cols="5" ></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
                                        <input id="jhxx_lb2" name="jhxx_lb2" value=""><br>
                                        <textarea id="jhxx2" name="jhxx2" rows="3" cols="5" ></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
                                        <input id="jhxx_lb3" name="jhxx_lb3" value=""><br>
                                        <textarea id="jhxx3" name="jhxx3" rows="3" cols="5" ></textarea>
                                    </div>
                                </div>
                                <div class="box-header well" data-original-title>
                                ...
                                <div class="control-group">
                                    <div class="controls">
                                        <textarea id="wxts1" name="wxts1" rows="3" cols="5" ></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
                                        <textarea id="wxts2" name="wxts2" rows="3" cols="5" ></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
                                        <textarea id="wxts3" name="wxts3" rows="3" cols="5" ></textarea>
                                    </div>
                                </div>
                                <div class="box-header well" data-original-title>
                                ...
                                <div class="control-group">
                                    <div class="controls">
                                        <textarea id="drjs1" name="drjs1" rows="3" cols="5" ></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
                                        <textarea id="drjs2" name="drjs2" rows="3" cols="5" ></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
                                        <textarea id="drjs3" name="drjs3" rows="3" cols="5" ></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
                                        <textarea id="drjs4" name="drjs4" rows="3" cols="5" ></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
                                        <textarea id="drjs5" name="drjs5" rows="3" cols="5" ></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">达人图</label>
                                    <div class="controls">
                                        <img id="img_a" src="" height="100ps" width="200ps" alt="未上传"/><br>
                                        <input id="fileurl" type="file" size="20" name="fileurl" >
                                        <input id="furl" name="furl" type="hidden">
