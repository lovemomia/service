            ...
            <div class="box span12">
                <div class="row-fluid sortable">
                    <div class="box-header well" data-original-title>
                        ...
                        <div class="box-icon">
                            <a href="${ctx}/sku/oper.do?uid=${user.id}&id=0&mark=0&pageNo=${queryPage.topPageNo}" class="btn btn-add btn-round"><i class=" icon-plus"></i></a>
                        </div>
                    </div>
                        ...
                        <form >
                            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                                <c:forEach items="${queryPage.list}" var="entity">
                                    ...
                                    <tr>
                                        <td class="center">
                                            <a class="btn btn-success" href="${ctx}/sku/oper.do?uid=${user.id}&id=${entity.id}&mark=1&pageNo=${queryPage.topPageNo}">
                                                <i class="icon-zoom-in icon-white"></i>
                                                价格编辑
                                            </a>
                                            <a class="btn btn-info" href="${ctx}/sku/oper.do?uid=${user.id}&id=${entity.id}&mark=2&pageNo=${queryPage.topPageNo}">
                                                <i class="icon-edit icon-white"></i>
                                                修改
                                            </a>
                                            <a class="btn btn-danger" href="${ctx}/sku/del.do?uid=${user.id}&id=${entity.id}&pageNo=${queryPage.topPageNo}">
